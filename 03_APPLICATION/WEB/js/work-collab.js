...
async function enhanceDetail(taskId){
  ...
  wrap.innerHTML=`<div class="collab-grid">${createChecklistPanel()}<section class="collab-panel"><div class="collab-head"><div><span class="eyebrow">TASK / COMMENTS</span><strong>Trao đổi</strong></div><span id="commentCount">0</span></div><div id="commentList"><span class="loading">Đang tải...</span></div><div class="comment-add"><textarea id="commentInput" rows="2" maxlength="500" placeholder="Viết trao đổi về công việc..."></textarea><button id="addComment" type="button">Gửi</button></div></section></div>`;
