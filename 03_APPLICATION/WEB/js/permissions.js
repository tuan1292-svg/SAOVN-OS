...
export function can(area,action='read'){
  const aliases={
    'members.read':PERMISSIONS.MEMBERS_VIEW,'members.manage':PERMISSIONS.MEMBERS_UPDATE,'members.create':PERMISSIONS.MEMBERS_CREATE,'members.update':PERMISSIONS.MEMBERS_UPDATE,'members.delete':PERMISSIONS.MEMBERS_DELETE,'members.role.manage':PERMISSIONS.MEMBERS_ROLE_MANAGE,
    ...
    'work.view':PERMISSIONS.WORK_VIEW,'work.read':PERMISSIONS.WORK_VIEW,'work.create':PERMISSIONS.WORK_CREATE,'work.edit':PERMISSIONS.WORK_EDIT,'work.delete':PERMISSIONS.WORK_DELETE,'work.assign':PERMISSIONS.WORK_ASSIGN,'work.comment':PERMISSIONS.WORK_COMMENT,'work.checklist':PERMISSIONS.WORK_CHECKLIST,
    'attendance.read':PERMISSIONS.ATTENDANCE_VIEW,'attendance.manage':PERMISSIONS.ATTENDANCE_MANAGE
  };
