...
async function loadDepartments(){
  ...
  }catch(error){console.warn('Không tải được danh sách phòng ban:',error);departments=[]}
...
async function saveOrganizationFields(){
  ...
  try{
    ...
    if($('detailEmailContact'))$('detailEmailContact').textContent=membership.email||$('detailEmailContact').textContent||'Chưa cập nhật';
