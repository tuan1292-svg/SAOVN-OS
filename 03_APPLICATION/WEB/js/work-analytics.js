...
async function run(user){
  ...
  try{
    ...
    const rows=members.map(member=>{
      ...
      return {member,total:assigned.length,done:done.length,overdueCount:overdue.length,onTime,percent};
