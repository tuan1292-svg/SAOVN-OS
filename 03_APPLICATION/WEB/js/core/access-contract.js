/* SAOVN-OS Core — Access Contract
 * Canonical vocabulary shared by UI modules and the Control Plane.
 * This is not a security boundary; Firestore Rules/backend remain authoritative.
 */
...
export const ACCESS = Object.freeze({
  ...
  ORGANIZATION: Object.freeze({
    ...
    DEPARTMENT_MANAGE: 'organization.department.manage'
  }),
  ...
  PROJECT: Object.freeze({
    VIEW: 'project.view', CREATE: 'project.create', UPDATE: 'project.update', DELETE: 'project.delete'
  }),
...
export function hasAccess(runtime, capability) {
  return Boolean(runtime?.can?.(capability));
}
...
export function visibleForScope(runtime, scope = {}) {
  ...
  if (requested === 'GLOBAL' || requested === 'GROUP') return runtime?.can?.('admin.system.manage') === true;
